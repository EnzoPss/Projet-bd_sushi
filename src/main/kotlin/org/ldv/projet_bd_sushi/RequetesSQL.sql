...
fk_box_id INT DEFAULT NULL REFERENCES boxes (box_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
fk_saveur_id INT DEFAULT NULL REFERENCES saveurs (saveur_id)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
...
fk_box_id INT DEFAULT NULL REFERENCES boxes (box_id)
   ON DELETE CASCADE
   ON UPDATE CASCADE,
fk_aliment_id INT DEFAULT NULL REFERENCES aliments (aliment_id)
   ON DELETE RESTRICT
   ON UPDATE CASCADE,
